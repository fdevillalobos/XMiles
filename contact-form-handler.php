...
<html>
<head>
  <title>Another Possible Customer</title>
</head>
<body>
  <p>This is the data of the person who subscribed</p>
  <table>
    <tr>
    ...
    <tr>
      <td>Subscribed on: '.$today[year].'-'.$today[mon].'-'.$today[mday].'</td>
    </tr>
  </table>
</body>
</html>
...
#headline p { color: #dfd9ff; font-family: Helvetica Neue, Arial, Helvetica, Geneva, sans-serif; font-size: 36px; text-align: center; margin-top:0px; margin-bottom:30px; }
#headline p a { color: #dfd9ff; text-decoration: none; }
        ...
        <tr>
            ...
            <td class="w580" width="580">
                <div align="center" id="headline">
                    <p>
                        <strong><a href="http://www.xmiles.tk"><singleline label="Title">XMiles.tk</singleline></a></strong>
                    </p>
                </div>
            </td>
            <td class="w30" width="30"></td>
                ...
                <repeater>
                    ...
                    <layout label="Text only">
                        <table class="w580" width="580" cellpadding="0" cellspacing="0" border="0">
                            <tbody><tr>
                                <td class="w580" width="580">
                                    <p align="left" class="article-title"><singleline label="Title">Thank You for your Interest!</singleline></p>
                                    <div align="left" class="article-content">
                                        <multiline label="Description">On behalf of all XMiles team we wanted to thank you for your interest. We will contact you again as soon as we have any exciting news about our company.</multiline>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tbody><tr>
                                <td class="w180" width="180" valign="top">
                                    <table class="w180" width="180" cellpadding="0" cellspacing="0" border="0">
                                        <tbody><tr>
                                            <td class="w180" width="180"><img src="http://www.xmiles.comxa.com/image/Under_Construction.png" alt="Site Under Contrstuction" editable="true" label="Image" class="w180" width="180" border="0"></td>
                                        </tr>
                                        <tr><td class="w180" width="180" height="10"></td></tr>
                                        <tr>
                                            <td class="w180" width="180">
                                                <div align="center" class="article-content">
                                                    <multiline label="Description">The Site is still Under Construction</multiline>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr><td class="w180" width="180" height="10"></td></tr>
                                ...
                                <td class="w180" width="180" valign="top">
                                    <table class="w180" width="180" cellpadding="0" cellspacing="0" border="0">
                                        <tbody><tr>
                                            <td class="w180" width="180"><img alt="Pay" src="http://www.xmiles.comxa.com/image/Flight_and_Savings_5.jpg" editable="true" label="Image" class="w180" width="180" border="0"></td>
                                        </tr>
                                        <tr><td class="w180" width="180" height="10"></td></tr>
                                        <tr>
                                            <td class="w180" width="180">
                                                <div align="center" class="article-content">
                                                    <multiline label="Description">Enjoy Savings while buying tickets</multiline>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr><td class="w180" width="180" height="10"></td></tr>
                                ...
                                <td class="w180" width="180" valign="top">
                                    <table class="w180" width="180" cellpadding="0" cellspacing="0" border="0">
                                        <tbody><tr>
                                            <td class="w180" width="180"><img alt="Pay" src="http://www.xmiles.comxa.com/image/Relax.jpg" editable="true" label="Image" class="w180" width="180" border="0"></td>
                                        </tr>
                                        <tr><td class="w180" width="180" height="10"></td></tr>
                                        <tr>
                                            <td class="w180" width="180">
                                                <div align="center" class="article-content">
                                                    <multiline label="Description">Relax while we do the work</multiline>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr><td class="w180" width="180" height="10"></td></tr>
...
// subject
$subject = 'New Subscriptor to XMiles.tk';
// multiple recipients
$to  = 'saspitz@hotmail.com' . ', ';
$to .= 'franciscodevillalobos@gmail.com';

// To send HTML mail, the Content-type header must be set
$headers  = 'MIME-Version: 1.0' . "\r\n";
$headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
// Additional headers
$headers .= 'To: Hernan <hernangerson@gmail.com>' . "\r\n";
$headers .= 'From: XMiles.tk <info@xmiles.tk>' . "\r\n";
$headers .= 'Cc: saspitz@hotmail.com' . "\r\n";
//$headers .= 'Bcc: birthdaycheck@example.com' . "\r\n";

// To send HTML mail, the Content-type header must be set
$headers_2  = 'MIME-Version: 1.0' . "\r\n";
$headers_2 .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
$headers_2 .= 'From: XMiles.tk <info@xmiles.tk>' . "\r\n";

// Mail it
mail($to, $subject, $message, $headers);
mail($email_address, $subject, $message_2, $headers_2);
